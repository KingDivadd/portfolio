import { service_data, work_data } from '@/constant'
...
const MyWork = () => {
    return (
        <main  id='work' className="w-full px-5 lg:px-8 xl:px-[8%] py-10 scroll-mt-20  flex flex-col items-center ">
            ...
            <Link href={''} className=' mt-[74px] w-[204px] h-[54px] sm:h-[64px] border border-[#A7A7A7] rounded-full flex items-center justify-center text-[#6F6F6F] text-[16px] gap-2' >
            Show more
